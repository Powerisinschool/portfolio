...
(function(module, exports, __webpack_require__) {
    ...
    function handlePlaybackRequest(playback, store) {
        ...
        if (actionListId && actionTypeId === _constants.ActionTypeConsts.GENERAL_START_ACTION || (0,
        _utils.isQuickEffect)(actionTypeId)) {
            stopActionGroup({
                store: store,
                actionListId: actionListId
            });
        ...
        _forEach["default"])(eventTargets, function(elements, key) {
            ...
            if (eventAction.actionTypeId === _constants.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION) {
                ...
                configs.forEach(function(eventConfig) {
                    ...
                    _find["default"])(paramGroups, function(_ref15) {
                        var id = _ref15.id;
            ...
            if (eventAction.actionTypeId === _constants.ActionTypeConsts.GENERAL_START_ACTION || (0,
            _utils.isQuickEffect)(eventAction.actionTypeId)) {
                renderInitialGroup({
                    store: store,
                    actionListId: actionListId,
                    eventId: eventId
 ...
 */
    ...
    function startActionGroup(_ref20) {
        ...
        var instanceDelay = isFirstGroup && (0,
        _utils.isQuickEffect)((_event$action = event.action) === null || _event$action === void 0 ? void 0 : _event$action.actionTypeId) ? event.config.delay : undefined;
...
(function(module, exports, __webpack_require__) {
    ...
    function getAffectedElements(_ref3) {
        ...
        var overrides = (0,
        _get["default"])(event, 'action.config.affectedElements', {});
    ...
    var getItemConfigByKey = function getItemConfigByKey(actionTypeId, key, config) {
        ...
        case STYLE_FILTER:
            {
                var filter = (0,
                _findLast["default"])(config.filters, function(_ref5) {
                    var type = _ref5.type;
                    return type === key;
                });
    ...
    var getFilterUnit = function getFilterUnit(filterType, actionItemConfig) {
        var filter = (0,
        _findLast["default"])(actionItemConfig.filters, function(_ref7) {
            var type = _ref7.type;
    ...
    Webflow.define('forms', module.exports = function($, _) {
        ...
        function addListeners() {
            ...
            CUSTOM_CONTROLS.forEach(function(_ref) {
                var _ref2 = (0,
                _slicedToArray2["default"])(_ref, 2)
                  , controlType = _ref2[0]
    ...
    "events": {
        "e-3": {
            ...
            "target": {
                ...
                "originalId": "5fa412d28203256893c09f60|71bade08-6a13-5c9a-4ec2-e7082d0d221d",
                "appliesTo": "CLASS"
            },
            "targets": [],
            "config": {
        ...
        "e-5": {
            ...
            "target": {
                "appliesTo": "ELEMENT",
                "styleBlockIds": [],
                "id": "5fa412d28203256893c09f60|390c9858-96a6-4cd4-2c95-514dacddc4e3"
            },
            "targets": [],
            "config": {
                "loop": false,
